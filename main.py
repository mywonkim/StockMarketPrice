...
class App(QWidget):
    ...
    def initUI(self):
        ...
        self.label.setText("1. Enter the ticker symbol of your company \nand click \"Enter\" button\n"
                           ...
                           "3. Click one of the three buttons: Live Price, \nPrice Prediction, or Price Trend\n"
    ...
    def predictPrice(self):
        whichCol, done1 = QInputDialog.getText(
            self, 'Open, High, Low, or Close', 'Enter what type of stock prices you want to predict: Open, High, Low, or Close: ')

        howManyDaysAfterTodayToPredict, done2 = QInputDialog.getInt(
            self, 'How many days after today?', 'You want to predict stock price in how many days?: ')
